 ...
 * @param fileBucket
 */
async function updateEmThumbnailData(
  filepath: string,
  mimetype: string,
  ...
  try {
    ...
    log.debug(`updateEmThumbnailData() Query: ${query}`)
 ...
 * @param fileBucket
 */
async function updateCollectionThumbnailData(
  filepath: string,
  mimetype: string,
  collectionid: string,
  filename: string,
  ...
  try {
    ...
    log.debug(`updateCollectionThumbnailData() Query: ${query}`)
