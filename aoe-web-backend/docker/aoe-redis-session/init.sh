...
# redis-server /usr/local/etc/redis/redis.conf --bind 0.0.0.0 --appendonly yes --requirepass redis_session_secret
redis-server /usr/local/etc/redis/redis.conf --appendonly yes --requirepass redis_session_secret
