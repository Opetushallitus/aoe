...
export class KoodistoService {
  ...
  private licenses$$: BehaviorSubject<License[] | null> = new BehaviorSubject<License[] | null>(
    null
  )
  ...
  updateBasicStudyContents(ids: string): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/sisaltoalueet/${ids}/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updatePreparatoryObjectives(ids: string): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/tuva-tavoitteet/${ids}/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updateUpperSecondarySchoolSubjectsOld(): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/lukio-vanha-oppiaineet/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updateUpperSecondarySchoolCoursesOld(ids: string): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/lukio-vanha-kurssit/${ids}/${lang}`,
        this.httpOptions
      )
      .subscribe(
        (subjects: AlignmentObjectExtended[]) => {
  ...
  updateUpperSecondarySchoolModulesNew(ids: string): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/lukio-moduulit/${ids}/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updateUpperSecondarySchoolObjectivesNew(ids: string): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/lukio-tavoitteet/${ids}/${lang}`,
        this.httpOptions
      )
      .subscribe(
        ...
        (error: HttpErrorResponse) =>
          this.handleError(error, this.upperSecondarySchoolObjectivesNew$)
      )
  }
  ...
  updateUpperSecondarySchoolContentsNew(ids: string): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/lukio-sisallot/${ids}/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updateVocationalDegrees(): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/ammattikoulu-tutkinnot/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updateVocationalCommonUnits(): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/ammattikoulu-yto-aineet/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updateVocationalRequirements(ids: string): void {
    ...
    this.http
      .get<AlignmentObjectExtended[]>(
        `${this.apiUri}/ammattikoulu-vaatimukset/${ids}/${lang}`,
        this.httpOptions
      )
      .subscribe(
  ...
  updateSpecialistVocationalQualifications(): void {
    this.http
      ...
      .subscribe(
        ...
        (error: HttpErrorResponse) =>
          this.handleError(error, this.specialistVocationalQualifications$)
      )
  }
  ...
  updateAccessibilityFeatures(): void {
    ...
    this.http
      .get<AccessibilityFeature[]>(
        `${this.apiUri}/saavutettavuudentukitoiminnot/${lang}`,
        this.httpOptions
      )
      .subscribe(
