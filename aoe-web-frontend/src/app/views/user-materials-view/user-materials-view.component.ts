...
export class UserMaterialsViewComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.unpublishedMaterialSubscription =
      this.materialService.unpublishedUserMaterials$$.subscribe(
        (materials: EducationalMaterialCard[]) => {
    ...
    this.translate
      ...
      .subscribe((translations: { [key: string]: string }) => {
        this.titleService.setTitle(
          `${translations['titles.userMaterials']} - ${translations['common.serviceName']}`
        )
      })
  }
