...
export class CollectionViewComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.collectionSubscription = this.collectionService.collection$.subscribe(
      (collection: Collection) => {
        ...
        collection.educationalMaterials.forEach((collectionMaterial) => {
          ...
          this.materialService
            .getCollectionMaterials(collectionMaterial.id)
            .subscribe((materials: Material[]) => {
              ...
              this.setPreviewMaterial(
                ...
                materials.find(
                  (material: Material) =>
                    material.language === this.selectedLanguages.get(collectionMaterial.id)
                )
              )
            })
        })
