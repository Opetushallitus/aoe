...
export class CollectionFormComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(CollectionEducationalDetailsTabComponent)
  educationalTab: CollectionEducationalDetailsTabComponent
  ...
  ngOnInit(): void {
    ...
    this.collectionSubscription = this.collectionSvc.editCollection$.subscribe(
      (collection: CollectionForm) => {
