...
export class EditBasicDetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    // educational roles
    this.educationalRoleSubscription = this.koodistoSvc.educationalRoles$.subscribe(
    ...
    // educational uses
    this.educationalUseSubscription = this.koodistoSvc.educationalUses$.subscribe(
      (uses: EducationalUse[]) => {
