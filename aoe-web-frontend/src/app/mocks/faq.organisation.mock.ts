...
export const FAQOrganisation = {
  ...
  en: [
    ...
    {
      question:
        'I would like to upload OERs made by my organization. Can I use an organizational account?',
      answer: [
  ...
  sv: [
    ...
    {
      question:
        'Har tjänsten öppna API:er? Hur kan vi visa öppna lärresurser i våra egna tjänster?',
      answer: [
