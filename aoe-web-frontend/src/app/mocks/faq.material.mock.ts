...
export const FAQMaterial = {
    ...
    {
      question:
        'Mitä minun pitää ottaa huomioon alkaessani tehdä oppimateriaalia? Asettaako Avointen oppimateriaalien kirjasto vaatimuksia oppimateriaalin tekemisen suhteen?',
      answer: [
        ...
        `Kannattaa tutustua myös <a href="https://www.oph.fi/fi/julkaisut/e-oppimateriaalin-laatukriteerit" target="_blank" rel="noopener nofollow">Opetushallituksen e-oppimateriaalien laatukiriteereihin (linkki kriteereihin)</a> ja miettiä mitä digitaaliselta oppimateriaalilta itse kaipaa. Myös <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/120">eAmk-hankkeen laatukriteerejä (linkki kriteereihin aoe.fissä)</a> on hyödyllistä käyttää soveltuvilta osin. Saavutettavuuden huomiointiin on vinkkejä tällä sivulla omassa kysymyksessään.`
      ]
    },
    {
    ...
    },
    {
      ...
      answer: [
        ...
        `Tarkemman ohjeistuksen löydät <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">käyttöohjeistamme</a>.`
      ]
    },
    {
      question:
    ...
    {
      question:
        'Tein X-alustalla materiaalin, miten saan sen ladattua alustalta jotta voin tallentaa sen Avointen oppimateriaalien kirjastoon?',
      answer: [
    ...
    },
    {
      ...
      answer: [
        `Voit omat oppimateriaalit -näkymästä klikata oppimateriaalin kohdalta muokkaa ja tämän jälkeen lisätä, poistaa tai vaihtaa oppimateriaalin kuvailutietoja sekä lisätä tai vaihtaa tiedostoja tai linkkejä, joista oppimateriaali koostuu. <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">Tarkemmat ohjeet oppimateriaalien päivittämiseen löydät ohjeistamme</a>. Aiemmat versiot säilyvät palvelussa ja ovat jatkossa nähtävissä versiohistoriasta.`,
  ...
  en: [
    {
      ...
      answer: [
        ...
        `Relevant sections of the <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/120">quality criteria for online implementations created</a> as part of the eAMK project can also be useful.`,
    ...
    },
    {
      ...
      answer: [
        ...
        `Read more from our <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">instructions</a>.`
      ]
    },
    {
      question:
    ...
    },
    {
      ...
      answer: [
        `You can edit your learning resources in the My open educational resources -view by clicking Edit underneath the resource you wish to edit. By doing this you can add, delete and change the metadata as well as the files and links that constitute the resource. <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">You can find a more detailed instruction here</a>. Previous versions of the learning resource are saved in the service and you can access them in the future through the learning resources version history.`,
  ...
  sv: [
    {
      question:
        'Vad ska jag beakta när jag börjar skapa undervisningsmaterial? Ställer Biblioteket för öppna lärresurser särskilda krav på materialen?',
      answer: [
        ...
        `Också projektet <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/120">eAMK:s kvalitetskriterier</a> är användbara till tillämpliga delar.`,
    ...
    },
    {
      ...
      answer: [
        ...
        `Läs mer från våra <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">anvisningarna</a>.`
      ]
    },
    {
      question:
    ...
    {
      question:
        'Jag skapade material på plattformen X. Hur kan jag ladda ned det från plattformen så att jag kan lagra det i Biblioteket för öppna lärresurser?',
      answer: [
    ...
    },
    {
      ...
      answer: [
        `Du kan redigera dina lärresurser i Mina lärresurser -sidan. Klick Redigera under lärresursen och då kan du lägga till, ta bort och ändra metadata samt de filer och länkar som utgör resursen. <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">Anvisning för redigering av lärresurser finns här</a>. Tidigare versioner av lärresursen sparas i tjänsten och du kan komma åt dem i framtiden genom lärresursens versionshistorik.`,
