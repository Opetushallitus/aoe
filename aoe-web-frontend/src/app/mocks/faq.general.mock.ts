...
export const FAQGeneral = {
    ...
    },
    {
      ...
      answer: [
        'Avoimet oppimateriaalit (Open Educational Resources, OER) ovat eri muotoisia digitaalisia tai muita opetukseen, kasvatukseen tai oppimiseen kohdennettuja materiaaleja, jotka on lisensoitu avoimella lisenssillä tai jotka on vapautettu public domainiin, joka antaa muille oikeuden maksuttomaan pääsyyn, käyttöön, muokkaukseen ja uudelleen jakamiseen olemattomin tai vähin rajoituksin.',
        'Avointen oppimateriaalien kirjastossa yksi avoin oppimateriaali on pedagogisesti koherentti kokonaisuus, joka on lisensoitu käyttäen Creative Commons -lisenssiä.'
      ]
    },
    {
      question: 'Kenelle Avointen oppimateriaalien kirjasto on tarkoitettu?',
      answer: [
        'Avointen oppimateriaalien kirjasto on suunnattu kaikille koulutusasteille ja jatkuvaan oppimiseen. Se palvelee niin opettajia, oppijoita kuin oppimisen tukijoita näiden etsiessä avoimia oppimateriaaleja oman opetuksen ja osaamisenkehittämisen tarpeisiin.'
      ]
    },
    {
      ...
      answer: [
        ...
        'Oppimateriaalien tallentaminen ja kommenttien jättäminen vaatii kirjautumisen. Tämä on mahdollista MPASSid:llä ja Hakalla sekä <a href="http://Suomi.fi" target="_blank" rel="noopener nofollow">Suomi.fi</a>-tunnistautumisella.'
      ]
    },
    {
      question:
        'Mitä Avointen oppimateriaalien kirjastoon tallennettavalta oppimateriaalilta vaaditaan?',
      answer: [
        ...
        'Jokaiseen lisättävään oppimateriaaliin on myös täydennettävä kuvailutietoa, jotka helpottavat oppimateriaalien löytämistä ja arviointia. Kuvailutiedot kertovat mm. kuka oppimateriaalin on tehnyt, mitä se käsittelee, kenelle tai mille koulutusasteelle se on suunnattu. On myös hyvä huomioida materiaalin saavutettavuus. <a href="http://www.saavutettavasti.fi" target="_blank" rel="noopener nofollow">Lisätietoja saavutettavuudesta Celian verkkosivuilta</a> sekä tältä Lisätietoa-sivulta.'
      ]
    },
    {
      ...
      answer: [
        ...
        `Huomioithan myös, että mikäli käytät muiden tekijöiden kuvia tms materiaaleja osana oppimateriaaliasi, tulee näidenkin olla avoimesti lisensoituja tai sinulla oikeus käyttää niitä avoimesti lisensoidussa oppimateriaalissa. Tekijänoikeuksista ja avoimesta lisensoinnista on myös opettajille suunnattu oppimateriaali <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/58">Tarmo Toikkasen tekemä Tekijänoikeudet opetuksessa -oppimateriaali (linkki materiaaliin aoe.fissä)</a>.`
      ]
    },
    {
      question:
        'Löytyykö Avointen oppimateriaalien kirjastosta kansainvälisten oppimateriaalivarantojen oppimateriaaleja? Miten näitä voi hyödyntää?',
      answer: [
        'Avointen oppimateriaalien kirjastosta ei löydy kansainvälisten oppimateriaalivarantojen oppimateriaaleja. Niiden hyödyntäminen on kuitenkin suositeltavaa! Voit etsiä näitä materiaaleja käyttäen palvelujen omia hakutoimintoja. Luotettavia lähteitä ovat esimerkiksi <a href="https://www.oercommons.org/" target="_blank" rel="noopener nofollow">OERCommons</a>, <a href="https://www.x5gon.org/" target="_blank" rel="noopener nofollow">x5Gon-discovery</a>, <a href="https://e-koolikott.ee/" target="_blank" rel="noopener nofollow">eKoolikott</a> ja <a href="https://ndla.no/en/" target="_blank" rel="noopener nofollow">NDLA</a>. Myös muita avoimia materiaaleja voi käyttää, esimerkiksi <a href="https://www.europeana.eu/en" target="_blank" rel="noopener nofollow">Europeanasta</a> löytyy paljon avoimia kuvia historiaan ja taiteisiin liittyen.',
    ...
    },
    {
      ...
      answer: [
        `Valitettavasti mbz-tiedostot vaativat Moodlen, jotta sitä voi katsoa. Periaatteessa tiedosto voi avautua myös johonkin toiseen oppimisen hallintajärjestelmään, mutta tällöin oppimateriaalin virheettömästä toimivuudesta ei ole takeita. Löydät lisätietoja moodle-oppimateriaaleista <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">käyttöohjeiden</a> osiosta "Tarkempia ohjeita blogistamme", otsikko "Kurssitiedostot avoimina oppimateriaaleina."`
      ]
    },
    {
    ...
    {
      question:
        'Miten merkitsen hyödyntämäni teoksen Creative Commons -lisenssin omaan oppimateriaaliini?',
      answer: [
        ...
        `Eli esimerkiksi: Toikkanen Tarmo, <a href="${urls.frontendUrl}/materiaali/58" target="_blank" rel="noopener nofollow">Tekijänoikeudet opetuksessa</a>. <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener nofollow">CC BY 4.0 -lisenssi</a>.`
      ]
    }
  ],
  en: [
    ...
    {
      question: 'Who is the service intended for?',
      answer: [
    ...
    },
    {
      ...
      answer: [
        ...
        'However, users must be logged in in order to save resources or leave comments. Logging into the service is possible via the Haka and MPASSid services as well as using <a href="https://suomi.fi/frontpage" target="_blank" rel="noopener nofollow">Suomi.fi</a> e-identification.'
      ]
    },
    {
    ...
    },
    {
      ...
      answer: [
        ...
        `Please also consider that if you use other creators’ images or other materials as part of your educational resource, these must be openly licensed or you must have permission to use them as part of openly licensed educational materials. Information on copyright and open licensing for teachers is available in the <a href="${urls.frontendUrl}/materiaali/58" target="_blank" rel="noopener nofollow">“Copyrights in Education” resource</a>.`
      ]
    },
    {
      question:
        'Can you find OER from international digital libraries in Library of Open Educational Resources (aoe.fi)? How can I use resources from such libraries?',
      answer: [
        'You will not find automatically harvested resources from different international digital libraries in the Library of Open Educational Resources (aoe.fi). But we do encourage you to use them! You can find OER from different digital libraries, for example in <a href="https://www.oercommons.org/" target="_blank" rel="noopener nofollow">OERCommons</a>, <a href="https://www.x5gon.org/" target="_blank" rel="noopener nofollow">x5Gon-discovery</a>, <a href="https://e-koolikott.ee/" target="_blank" rel="noopener nofollow">eKoolikott</a> (Estonian) and <a href="https://ndla.no/en/" target="_blank" rel="noopener nofollow">NDLA</a> (Norweigian). We also encourage you to use other open materials, for example you can find many open pictures relating to history and arts in <a href="https://www.europeana.eu/en" target="_blank" rel="noopener nofollow">Europeana</a>.',
    ...
    },
    {
      ...
      answer: [
        `Unfortunately mbz files can only be used in a Moodle. It might be possible to open the OER in a different learning environment but there would be no quarantees that the OER would function accordingly. You can read more about Moodle related OERs from <a target="_blank" rel="noopener nofollow" href="${urls.frontendUrl}/materiaali/606">instructions</a> (in Finnish: Tarkempia ohjeita blogistamme, article Kurssitiedostot avoimina oppimateriaaleina).`
      ]
    },
    {
      question:
        'How do I make a reference to an educational resource found in the Library of Open Educational Resources?',
      answer: [
    ...
    },
    {
      ...
      answer: [
        ...
        `E.g. Toikkanen Tarmo, <a href="${urls.frontendUrl}/materiaali/58" target="_blank" rel="noopener nofollow"> Copyright in Teaching. </a><a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener nofollow">CC BY 4.0 license.</a>`
      ]
    }
  ],
  sv: [
    ...
    {
      question:
        'Vad krävs av det undervisningsmaterial som sparas i Biblioteket för öppna lärresurser?',
      answer: [
    ...
    {
      question:
        'Hur hänvisar jag till det undervisningmaterial som finns i Biblioteket för öppna lärresurser?',
      answer: [
    ...
    },
    {
      ...
      answer: [
        ...
        `T.ex: Toikkanen Tarmo, <a href="${urls.frontendUrl}/materiaali/58" target="_blank" rel="noopener nofollow"> Upphovsrätten i undervisningen. </a><a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener nofollow">CC BY 4.0 -licens.</a>`
      ]
    }
  ]
}
