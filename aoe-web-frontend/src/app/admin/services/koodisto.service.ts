...
export class KoodistoService {
  ...
  private educationalLevelsBehaviorSubject: BehaviorSubject<EducationalLevel[] | null> =
    new BehaviorSubject<EducationalLevel[] | null>(null)
  private educationalSubjectsBehaviorSubject: BehaviorSubject<EducationalSubject[] | null> =
    new BehaviorSubject<EducationalSubject[] | null>(null)
  private organizationsBehaviorSubject: BehaviorSubject<Organization[] | null> =
  ...
  public organizations$: Observable<Organization[] | null> =
    this.organizationsBehaviorSubject.asObservable()
    ...
    return this.http
      ...
      .pipe(
        map((educationalLevels: EducationalLevel[]) =>
          educationalLevels.filter(
            (educationalLevel: EducationalLevel): boolean => educationalLevel !== null
          )
        ),
