...
async function insertDataToEducationalMaterialTable(req: Request) {
    const query = "insert into educationalmaterial (materialName,slug,CreatedAt,PublishedAt,UpdatedAt,Description,TechnicalName,author,organization,publisher,timeRequired,agerangeMin,agerangeMax,UsersId) values ('" + req.body.materialname + "','slugi kolmas',to_date('1900-01-01', 'YYYY-MM-DD'),to_date('1900-01-01', 'YYYY-MM-DD'),to_date('1900-01-01', 'YYYY-MM-DD'),'kuvaus','tekninen nimi','tekijä','CSC',123,'300','1','12','" + req.body.usersid + "') returning id;";
