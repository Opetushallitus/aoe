...
export class CollectionEducationalDetailsTabComponent implements OnInit, OnDestroy {
    ...
    educationalLevelsChange(value: EducationalLevel[]): void {
        this.hasEarlyChildhoodEducation =
            value.filter((level: EducationalLevel) => educationalLevelKeys.earlyChildhood.includes(level.key)).length >
            0;
        ...
        this.hasUpperSecondarySchool =
            value.filter((level: EducationalLevel) => educationalLevelKeys.upperSecondary.includes(level.key)).length >
            0;
        ...
        this.hasSelfMotivatedEducation =
            value.filter((level: EducationalLevel) => educationalLevelKeys.selfMotivated.includes(level.key)).length >
            0;

        this.hasHigherEducation =
            value.filter((level: EducationalLevel) => educationalLevelKeys.higherEducation.includes(level.key)).length >
            0;
    }
