...
export const FAQ: Faq[] = [
  ...
  },
  {
    ...
    answer: [
      'Avointen oppimateriaalien palveluun lisättävä oppimateriaali on oltava avoimesti lisensoitu. Palvelussa käytetään Creative Commons -lisenssejä, joista lisätietoa täältä: https://creativecommons.org/choose/?lang=fi',
      'Jokaiseen lisättävään oppimateriaaliin on myös täydennettävä kuvailutietoa, jotka helpottavat oppimateriaalien löytämistä ja arviointia. Kuvailutiedot kertovat mm. kuka oppimateriaalin on tehnyt ja miten se opettaa suhteessa opetussuunnitelmiin. On myös hyvä huomioida materiaalin saavutettavuus. Lisätietoja: www.saavutettavasti.fi',
    ]
  },
  {
    id: 6,
    ...
    answer: [
      'Creative Commons lisenssien avulla jaat teoksen käyttäjille haluamasi vapaudet teokseesi, esimerkiksi oikeuden käyttää, jakaa tai muokata materiaalia. Creative Commons -lisenssit rakentuvat Nimeä-ehdon päälle, joka antaa muiden kopioida, välittää, levittää ja esittää sinun tekijänoikeuksiisi kuuluvaa teosta sekä sen pohjalta tehtyjä muokattuja versioita teoksestasi vain, jos he mainitsevat nimesi alkuperäisenä tekijänä. Tämän lisäksi lisenssiin voi valita lisäehtoja kuten kaupallisen käytön tai muokattujen teosten kieltäminen. Lisätietoa https://creativecommons.fi/lisenssit/',
