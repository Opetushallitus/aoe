  ...
  sv: [
    {
      ...
      answer: [
        ...
        'Det lönar sig att gå igenom Utbildningsstyrelsens kvalitetskriterier för digitala läromaterial och fundera på vad man själv vill ha ut av dem: <a href="https://www.oph.fi/fi/julkaisut/e-oppimateriaalin-laatukriteerit" target="_blank" rel="noopener nofollow">https://www.oph.fi/fi/julkaisut/e-oppimateriaalin-laatukriteerit</a> (på finska).',
        'Också projektet eAMK:s kvalitetskriterier är användbara till tillämpliga delar. De finns på <a href="https://www.eamk.fi/sv/kursutbud/kvalitetskriterierna/" target="_blank" rel="noopener nofollow">https://www.eamk.fi/sv/kursutbud/kvalitetskriterierna/</a>.',
    ...
    },
    {
      ...
      answer: [
        ...
        'Mer information finns till exempel i snabbguiden för innehållsproducenter i Förbundet Utvecklingshämnings tjänst Papunet (på finska): <a href="http://papunet.net/saavutettavuus/pikaopas-sisallontuottajille" target="_blank" rel="noopener nofollow">http://papunet.net/saavutettavuus/pikaopas-sisallontuottajille</a>.',
        'I tjänsten för öppna lärresurser kan du i beskrivningen också lägga till information om hur tillgängligheten har beaktats i materialet. Det underlättar för användarna att hitta material som passar dem. Det finns mera information om metadata i tjänstens <a href="http://www.saavutettavasti.fi/#Oppimateriaalienmetatietomalli-saavutettavuus" target="_blank" rel="noopener nofollow">öppna wiki</a> (på finska).',
      ]
    },
  ]
};
