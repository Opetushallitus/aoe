...
export const FAQGeneral = {
  ...
  en: [
    {
      question: 'What is the Library of Open Educational Resources? Why is the Library of Open Educational Resources being developed, and which needs is it intended to fulfill?',
      answer: [
