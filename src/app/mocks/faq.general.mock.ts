...
export const FAQGeneral = {
    ...
    },
    {
      ...
      answer: [
        ...
        'Avointen oppimateriaalien kirjastossa yksi avoin oppimateriaali on pedagogisesti järkevä kokonaisuus, joka on lisensoitu käyttäen Creative Commons -lisenssiä.',
      ]
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      answer: [
        'Materials uploaded to the Open Educational Resources Service must be openly licensed. The service uses Creative Commons licenses. For further information, see <a href="https://creativecommons.org/choose/?lang=en" target="_blank" rel="noopener nofollow">https://creativecommons.org/choose/?lang=en</a> and this FAQ. The license is indicated in the material description of the resource in question, but it is advisable to also make a note of it within the resource itself.',
        'All uploaded resources must also be accompanied by material descriptions, which help users find and evaluate them. The descriptions include information e.g. on who has created the resource and how it relates to curricula. Accessibility factors should also be taken into account when necessary. Further information: <a href="www.saavutettavasti.fi" target="_blank" rel="noopener nofollow">www.saavutettavasti.fi</a> (in Finnish).',
      ]
    },
    {
