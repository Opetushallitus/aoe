      ...
      .subscribe((material) => {
        if (JSON.stringify(material) === '{}') {
          ...
          const materials = material.materials.map((m) => ({
            ...
            downloadUrl: `https://localhost:3000/download/file/${m.filekey}`,
          }));
          ...
          this.material$.next({
            ...
            learningResourceTypes: material.learningResourceTypes.map(({ learningresourcetypekey, value }) => ({
            ...
            accessibilityHazards: material.accessibilityHazards.map(({ accessibilityhazardkey, value }) => ({
      ...
      .subscribe((materials) => {
        ...
        materials.forEach((material) => {
          const mappedMaterial: EducationalMaterialCard = {
            ...
            authors: material.authors.map(({ authorname, organization }) => ({ authorname, organization })),
            description:
          ...
          return res
            ...
            .map((r) => {
              return {
                ...
                learningResourceTypes: r.learningResourceTypes.map(({ learningresourcetypekey, value }) => ({
                  learningresourcetypekey,
                  value,
                })),
                authors: r.authors.map(({ authorname, organization }) => ({ authorname, organization })),
                description:
