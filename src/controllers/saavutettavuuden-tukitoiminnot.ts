 ...
 * @returns {Promise<any>}
 */
export const getSaavutettavuudenTukitoiminnot = async (req: any, res: any, next: any): Promise<any> => {
    try {
 ...
 * @returns {Promise<any>}
 */
export const getSaavutettavuudenTukitoiminto = async (req: any, res: any, next: any): Promise<any> => {
    try {
        const redisData = await getAsync(`${rediskey}.${req.params.lang.toLowerCase()}`);
