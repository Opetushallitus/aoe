...
const endpoint = "SaavutettavuusKayttotavat";
 ...
 * @returns {Promise<any>}
 */
export const getSaavutettavuudenKayttotavat = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
 ...
 * @returns {Promise<any>}
 */
export const getSaavutettavuudenKayttotapa = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  if (await client.exists(rediskey) !== true) {
    res.sendStatus(404);
