 ...
 * @returns {Promise<any>}
 */
export const getSaavutettavuudenEsteet = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  client.get(rediskey, async (error: any, data: any) => {
    if (data) {
 ...
 * @returns {Promise<any>}
 */
export const getSaavutettavuudenEste = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  client.get(rediskey, async (error: any, data: any) => {
    if (data) {
      const input = JSON.parse(data);
