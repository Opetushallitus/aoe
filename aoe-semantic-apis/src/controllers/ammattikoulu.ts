...
export async function setAmmattikoulunPerustutkinnot(): Promise<void> {
  ...
  while (getResults) {
    ...
    if (!results || !(results as any).data || (results as any).data.length < 1 || (results as any).sivu === undefined) {
      winstonLogger.error('No data from ePerusteet in setAmmattikoulunPerustutkinnot() on page %s', pageNumber);
      return;
    }
...
export async function setAmmattikoulunTutkinnonOsat(): Promise<void> {
  ...
  for (const degree of degrees) {
    ...
    if (!results || !(results as any).tutkinnonOsat || (results as any).tutkinnonOsat.length < 1) {
      winstonLogger.error('No data from ePerusteet for degree %s in setAmmattikoulunTutkinnonOsat()', degree);
      return;
    }
...
export const getAmmattikoulunTutkinnonOsat = async (
  ...
  try {
    ...
    next(err);
    winstonLogger.error('Getting units of vocational education failed in getAmmattikoulunTutkinnonOsat()');
  }
};
...
export const getAmmattikoulunVaatimukset = async (
  ...
  try {
    ...
    next(err);
    winstonLogger.error('Getting learning objects of vocational education failed in getAmmattikoulunVaatimukset()');
  }
};
...
export async function setAmmattikoulunAmmattitutkinnot(): Promise<void> {
  ...
  while (getResults) {
    ...
    if (!results || !(results as any).data || (results as any).data.length < 1 || (results as any).sivu === undefined) {
      winstonLogger.error('No data from ePerusteet in setAmmattikoulunAmmattitutkinnot() on page %s', pageNumber);
      return;
    }
...
export const getAmmattikoulunAmmattitutkinnot = async (
  ...
  try {
    ...
    next(err);
    winstonLogger.error('Getting further vocational qualifications failed in getAmmattikoulunAmmattitutkinnot()');
  }
};
...
export async function setAmmattikoulunErikoisammattitutkinnot(): Promise<void> {
  ...
  while (getResults) {
    ...
    if (!results || !(results as any).data || (results as any).data.length < 1 || (results as any).sivu === undefined) {
      winstonLogger.error('No data from ePerusteet in setAmmattikoulunErikoisammattitutkinnot() on page ' + pageNumber);
      return;
    }
...
export async function setAmmattikoulunYTOaineet(): Promise<void> {
  ...
  if (!results || !(results as any).tutkinnonOsat || (results as any).tutkinnonOsat.length < 1) {
    winstonLogger.error('No data from ePerusteet in setAmmattikoulunYTOaineet(): Missing required data');
    return;
  }
...
export const getAmmattikoulunYTOaineet = async (
  ...
  try {
    ...
    next(err);
    winstonLogger.error('Getting common units of vocational education failed in getAmmattikoulunYTOaineet()');
  }
};
