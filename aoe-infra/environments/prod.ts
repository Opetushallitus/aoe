  ...
  services: {
    ...
    data_services: {
      ...
      env_vars: {
        SPRING_PROFILES_ACTIVE: 'prod',
        SERVER_PORT: '8080',
        AOE_OAIIDENTIFIER_REPOSITORYIDENTIFIER: 'aoe.fi',
        AOE_REQUEST_PERPAGE: '20',
        AOE_REQUEST_URL: 'http://web-backend.prod.aoe.local:8080/api/v1/oaipmh/metadata'
      }
    },
    web_frontend: {
      cpu_limit: '2048',
    ...
    web_backend: {
      ...
      env_vars: {
        ...
        LOG_LEVEL: 'debug',
        PORT_LISTEN: '8080',
        MATERIAL_VERSION_URL: 'https://aoe.fi/#/materiaali/',
        HTTP_OPTIONS_TIMEOUT: '5000',
        HTTP_OPTIONS_RETRY: '2',
        HTTP_OPTIONS_CLOCK_TOLERANCE: '5',
        POSTGRESQL_DATA: 'aoe',
        PG_USER: 'aoe_admin',
        SERVER_CONFIG_OAIPMH_ANALYTICS_URL: 'http://data-analytics.prod.aoe.local:8080',
        DATA_ANALYTICS_MIGRATION_TO_POSTGRES_ENABLED: 'true',
        MONGODB_PRIMARY_DATABASE: 'analytics',
        MONGODB_PRIMARY_USERNAME: 'aoeOwner',
        MONGODB_PRIMARY_ENABLE_SSL: 'true',
        ...
        CLOUD_STORAGE_BUCKET: 'aoe-prod',
        CLOUD_STORAGE_BUCKET_PDF: 'aoepdf-prod',
        CLOUD_STORAGE_BUCKET_THUMBNAIL: 'aoethumbnail-prod',
        THUMBNAIL_END_POINT: '/app/thumbnail/',
        FILE_SIZE_LIMIT: '10737418240',
        THUMBNAIL_FILE_SIZE_LIMIT: '10485760',
        REDIRECT_URI: 'https://aoe.fi/api/secure/redirect',
        ...
        CONVERSION_TO_PDF_API: 'https://aoe.fi/api/v1/pdf/content/',
        FILE_DOWNLOAD_URL: 'https://aoe.fi/api/v1/download/file/',
        THUMBNAIL_DOWNLOAD_URL: 'https://aoe.fi/api/v1/thumbnail/',
        COLLECTION_THUMBNAIL_DOWNLOAD_URL: 'https://aoe.fi/api/v1/collection/thumbnail/',
        REDIS_USERNAME: 'app',
        REDIS_USE_TLS: 'true',
        BASE_URL: 'https://aoe.fi/api/v1/',
        EMAIL_FROM: 'oppimateriaalivaranto@aoe.fi',
        SEND_EXPIRATION_NOTIFICATION_EMAIL: '1',
        SEND_RATING_NOTIFICATION_EMAIL: '1',
        ...
        STREAM_REDIRECT_URI: 'https://aoe.fi/stream/api/v1/material/',
        STREAM_STATUS_HOST: 'streaming-app.prod.aoe.local',
